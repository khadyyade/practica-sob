...
<body>
    <div class="container">
        ...
        <div class="filter-panel">
            ...
            <form action="${pageContext.request.contextPath}/Web/" method="GET" class="filter-form">
                <!-- Capabilities Filter -->
                <div class="form-group">
                    <label>Capabilities (Máximo 2):</label>
                    <div class="capability-checkboxes">
                        <label>
                            <input type="checkbox" name="capability" value="chat-completion" 
                                   <c:if test="${filters.capabilities.contains('chat-completion')}">checked</c:if>>
                            Chat Completion
                        </label>
                        <label>
                            <input type="checkbox" name="capability" value="code-generation" 
                                   <c:if test="${filters.capabilities.contains('code-generation')}">checked</c:if>>
                            Code Generation
                        </label>
                        <label>
                            <input type="checkbox" name="capability" value="text-to-image" 
                                   <c:if test="${filters.capabilities.contains('text-to-image')}">checked</c:if>>
                            Text to Image
                        </label>
                        <label>
                            <input type="checkbox" name="capability" value="audio-generation" 
                                   <c:if test="${filters.capabilities.contains('audio-generation')}">checked</c:if>>
                            Audio Generation
                        </label>
                    </div>
                </div>
                ...
                <div class="form-group">
                    ...
                    <input type="text" 
                           id="provider" 
                           name="provider" 
                           placeholder="e.g., OpenAI, Mistral, Anthropic"
                ...
                <div class="form-group">
                    <div class="filter-actions">
                        ...
                        <button type="button" class="btn btn-secondary" onclick="window.location.href='${pageContext.request.contextPath}/Web/'">Limpiar</button>
                    </div>
                </div>
            </form>
        </div>
            ...
            <c:otherwise>
                <div class="models-grid">
                    <c:forEach items="${models}" var="model">
                        <div class="model-card" onclick="window.location.href='${pageContext.request.contextPath}/Web/model/${model.id}'">
